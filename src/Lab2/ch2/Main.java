...
public class Main {
        ...
        for(Studio currentStudio:studioDatabase){
            if(currentStudio.count()>=2) {
                if(i == studioNames.length){
                    String[] newStudioNames=new String[studioNames.length+2];
                    for(int j=0;j<i;j++){
    ...
    public static void main(String[] args) {
        ...
        Studio studio3 = new Studio("Disney2", new Film[]{film3, film4, film5});
        Studio studio4 = new Studio("Disney3", new Film[]{film3, film1});
